/*
  * kony-sdk-ide Version mBaaSSDK-QA-7.2.0.4
  */
...
kony.sdk.version = "mBaaSSDK-QA-7.2.0.4";
...
function IdentityService(konyRef, rec) {
    ...
    var processLoginSuccessResponse = function(data,konyRef,isAsync,callBack){
		...
		if((data.sso_token === null || data.sso_token === undefined) && kony.sdk.isSSOEnabled === true)
...
function OAuthHandler(serviceUrl, providerName, appkey, callback, type) {
	var urlType = "/" + type + "/";
	if (typeof(XMLHttpRequest) !== 'undefined') {
		...
		_attachEvent();
		var _popup = _window.open(serviceUrl + urlType + "login?provider=" + providerName + "&appkey=" + appkey);
	}
	else {
		var popBasic = {
			id: "popUp",
